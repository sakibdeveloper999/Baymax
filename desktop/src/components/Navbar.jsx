...
export default function Navbar({ onSidebarToggle }) {
    ...
    return <header className="bg-white border-b border-gray-200 shadow-sm">
        <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center gap-4"><button aria-label="Toggle navigation" onClick={onSidebarToggle} className="p-2 hover:bg-gray-100 rounded">Menu</button><h2 className="text-lg font-semibold">Baymax OmniPOS</h2></div>
